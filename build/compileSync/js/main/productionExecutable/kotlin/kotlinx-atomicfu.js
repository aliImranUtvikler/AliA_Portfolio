(function (factory) {
  ...
  var get_ONE = kotlin_kotlin.$_$.b6;
  ...
  protoOf(atomicfu$AtomicRefArray$ref).uo = function () {
    return this.to_1.length;
  };
  ...
  protoOf(AtomicRef).vo = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).wo = function () {
  ...
  protoOf(AtomicInt).xo = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).wo = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicBoolean).yo = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).wo = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).zo = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).wo = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).uo);
  //endregion
